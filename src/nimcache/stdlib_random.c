...
N_LIB_PRIVATE N_NIMCALL(NI, rand_llsvpw3XcUUMY9bBfAwkSMg)(tyObject_Rand_liBKmwv1H6v7oYBhDFHa6A* r, tyObject_HSlice_x7qpDivRIi6zcMSMsudNPA x) {
	NI result;
	NI TM_AIKkgex03Z1j45JceakCTA_5;
	NI T1_;
	NI TM_AIKkgex03Z1j45JceakCTA_6;
	nimfr_("rand", "random.nim");
	result = (NI)0;
	nimln_(152, "random.nim");
	TM_AIKkgex03Z1j45JceakCTA_5 = subInt(x.b, x.a);
	T1_ = (NI)0;
	T1_ = rand_f9cZ4wTU5lMiIukSmr9btSpg(r, (NI)(TM_AIKkgex03Z1j45JceakCTA_5));
	TM_AIKkgex03Z1j45JceakCTA_6 = addInt(T1_, x.a);
	result = (NI)(TM_AIKkgex03Z1j45JceakCTA_6);
	popFrame();
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(NI, rand_an9ajRjsC0saLyxF46lqhIw)(tyObject_HSlice_x7qpDivRIi6zcMSMsudNPA x) {
	...
	nimfr_("rand", "random.nim");
	result = (NI)0;
	nimln_(156, "random.nim");
	result = rand_llsvpw3XcUUMY9bBfAwkSMg((&state_4atHrcHUZPts5LqH9bzbl0w), x);
	popFrame();
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(tyEnum_PersonalityType_gdWQV5cGkpq7KxGxo9aIyQQ, rand_PcJft7w0FmlF27beget4GQ)(tyEnum_PersonalityType_gdWQV5cGkpq7KxGxo9aIyQQ* a, NI aLen_0) {
	...
	T1_ = dotdot__vDQySKWzgnxQdUarow6k5Qtimes(((NI) 0), (aLen_0-1));
	T2_ = (NI)0;
	T2_ = rand_an9ajRjsC0saLyxF46lqhIw(T1_);
	if ((NU)(T2_) >= (NU)(aLen_0)) raiseIndexError();
	result = a[T2_];
	popFrame();
	return result;
}
