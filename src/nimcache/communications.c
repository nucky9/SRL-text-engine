...
N_LIB_PRIVATE N_NIMCALL(tyObject_CommunicationsOfficercolonObjectType__wnFlv9aO9aNGi3o5MybXAQyQ*, generateCommunicationsOfficer_EF9cuDLp9bDwPtK9b1CL9cy83Q)(tyObject_BaseCrewInfo_XKHobPLd3O3l3A9aqud8UbQ* baseCrewInfo) {
	tyObject_CommunicationsOfficercolonObjectType__wnFlv9aO9aNGi3o5MybXAQyQ* result;
	tyObject_CommunicationsOfficercolonObjectType__wnFlv9aO9aNGi3o5MybXAQyQ* T1_;
	nimfr_("generateCommunicationsOfficer", "communications.nim");
	result = (tyObject_CommunicationsOfficercolonObjectType__wnFlv9aO9aNGi3o5MybXAQyQ*)0;
	nimln_(6, "communications.nim");
	T1_ = (tyObject_CommunicationsOfficercolonObjectType__wnFlv9aO9aNGi3o5MybXAQyQ*)0;
	T1_ = (tyObject_CommunicationsOfficercolonObjectType__wnFlv9aO9aNGi3o5MybXAQyQ*) newObj((&NTI_9b9bLL9aVzoJ5c0S8E9ajEDJXA_), sizeof(tyObject_CommunicationsOfficercolonObjectType__wnFlv9aO9aNGi3o5MybXAQyQ));
...
NIM_EXTERNC N_NOINLINE(void, unknown_communicationsInit000)(void) {
	nimfr_("communications", "communications.nim");
	popFrame();
}
