...
N_LIB_PRIVATE N_NIMCALL(tyObject_NavigationOfficercolonObjectType__2TU9cTQpfMOQw06LCgDZx3Q*, generateNavigationOfficer_ksohtDr9a1dAL8lDDhskAvQ)(tyObject_BaseCrewInfo_XKHobPLd3O3l3A9aqud8UbQ* baseCrewInfo) {
	tyObject_NavigationOfficercolonObjectType__2TU9cTQpfMOQw06LCgDZx3Q* result;
	tyObject_NavigationOfficercolonObjectType__2TU9cTQpfMOQw06LCgDZx3Q* T1_;
	nimfr_("generateNavigationOfficer", "navigation.nim");
	result = (tyObject_NavigationOfficercolonObjectType__2TU9cTQpfMOQw06LCgDZx3Q*)0;
	nimln_(7, "navigation.nim");
	T1_ = (tyObject_NavigationOfficercolonObjectType__2TU9cTQpfMOQw06LCgDZx3Q*)0;
	T1_ = (tyObject_NavigationOfficercolonObjectType__2TU9cTQpfMOQw06LCgDZx3Q*) newObj((&NTI_9bn9cFcdfV2ORVXywWKHaRCg_), sizeof(tyObject_NavigationOfficercolonObjectType__2TU9cTQpfMOQw06LCgDZx3Q));
...
NIM_EXTERNC N_NOINLINE(void, unknown_navigationInit000)(void) {
	nimfr_("navigation", "navigation.nim");
	popFrame();
}
