...
N_LIB_PRIVATE N_NIMCALL(tyObject_ScienceOfficercolonObjectType__fSGVZJXYXAS4sa5877WqRw*, generateScienceOfficer_V3UIwQyRth70mCYQh0sqNA)(tyObject_BaseCrewInfo_XKHobPLd3O3l3A9aqud8UbQ* baseCrewInfo) {
	tyObject_ScienceOfficercolonObjectType__fSGVZJXYXAS4sa5877WqRw* result;
	tyObject_ScienceOfficercolonObjectType__fSGVZJXYXAS4sa5877WqRw* T1_;
	nimfr_("generateScienceOfficer", "science.nim");
	result = (tyObject_ScienceOfficercolonObjectType__fSGVZJXYXAS4sa5877WqRw*)0;
	nimln_(7, "science.nim");
	T1_ = (tyObject_ScienceOfficercolonObjectType__fSGVZJXYXAS4sa5877WqRw*)0;
	T1_ = (tyObject_ScienceOfficercolonObjectType__fSGVZJXYXAS4sa5877WqRw*) newObj((&NTI_PzqjnrSNOeItfuyXAztypw_), sizeof(tyObject_ScienceOfficercolonObjectType__fSGVZJXYXAS4sa5877WqRw));
